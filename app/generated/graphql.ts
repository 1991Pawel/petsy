...
/** Asset system model */
export type AssetImageHotelArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
...
export type AssetCreateInput = {
  ...
  imageHotel?: InputMaybe<HotelCreateManyInlineInput>;
...
export type AssetManyWhereInput = {
  ...
  /** All values starting with the given string. */
  id_starts_with?: InputMaybe<Scalars['ID']['input']>;
  imageHotel_every?: InputMaybe<HotelWhereInput>;
  imageHotel_none?: InputMaybe<HotelWhereInput>;
  imageHotel_some?: InputMaybe<HotelWhereInput>;
  publishedAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than or equal the given value. */
...
export type AssetUpdateInput = {
  ...
  height?: InputMaybe<Scalars['Float']['input']>;
  imageHotel?: InputMaybe<HotelUpdateManyInlineInput>;
...
export type HotelCreateInput = {
  ...
  review?: InputMaybe<HotelReviewCreateManyInlineInput>;
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
};
...
export type HotelManyWhereInput = {
  ...
  review_empty?: InputMaybe<Scalars['Boolean']['input']>;
  /** Matches if the union contains at least one connection to the provided item to the filter */
  review_some?: InputMaybe<HotelReviewWhereInput>;
  scheduledIn_every?: InputMaybe<ScheduledOperationWhereInput>;
  scheduledIn_none?: InputMaybe<ScheduledOperationWhereInput>;
  scheduledIn_some?: InputMaybe<ScheduledOperationWhereInput>;
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
...
export type HotelReviewConnectInput = {
...
export type HotelReviewCreateManyInlineInput = {
  /** Connect multiple existing HotelReview documents */
  connect?: InputMaybe<Array<HotelReviewWhereUniqueInput>>;
  /** Create and connect multiple existing HotelReview documents */
  create?: InputMaybe<Array<HotelReviewCreateInput>>;
};

export type HotelReviewCreateOneInlineInput = {
  /** Connect one existing HotelReview document */
  connect?: InputMaybe<HotelReviewWhereUniqueInput>;
  /** Create and connect one HotelReview document */
  create?: InputMaybe<HotelReviewCreateInput>;
};
...
export type HotelReviewUpdateManyInlineInput = {
  /** Connect multiple existing HotelReview documents */
  connect?: InputMaybe<Array<HotelReviewConnectInput>>;
  /** Create and connect multiple HotelReview documents */
  create?: InputMaybe<Array<HotelReviewCreateInput>>;
  /** Delete multiple HotelReview documents */
  delete?: InputMaybe<Array<HotelReviewWhereUniqueInput>>;
  /** Disconnect multiple HotelReview documents */
  disconnect?: InputMaybe<Array<HotelReviewWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing HotelReview documents */
  set?: InputMaybe<Array<HotelReviewWhereUniqueInput>>;
  /** Update multiple HotelReview documents */
  update?: InputMaybe<Array<HotelReviewUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple HotelReview documents */
  upsert?: InputMaybe<Array<HotelReviewUpsertWithNestedWhereUniqueInput>>;
};

export type HotelReviewUpdateManyWithNestedWhereInput = {
  Review?: InputMaybe<ReviewUpdateManyWithNestedWhereInput>;
};

export type HotelReviewUpdateOneInlineInput = {
  /** Connect existing HotelReview document */
  connect?: InputMaybe<HotelReviewWhereUniqueInput>;
  /** Create and connect one HotelReview document */
  create?: InputMaybe<HotelReviewCreateInput>;
  /** Delete currently connected HotelReview document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Disconnect currently connected HotelReview document */
  disconnect?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single HotelReview document */
  update?: InputMaybe<HotelReviewUpdateWithNestedWhereUniqueInput>;
  /** Upsert single HotelReview document */
  upsert?: InputMaybe<HotelReviewUpsertWithNestedWhereUniqueInput>;
};

export type HotelReviewUpdateWithNestedWhereUniqueInput = {
  Review?: InputMaybe<ReviewUpdateWithNestedWhereUniqueInput>;
};

export type HotelReviewUpsertWithNestedWhereUniqueInput = {
...
export type HotelReviewWhereUniqueInput = {
...
export type HotelUpdateInput = {
  ...
  name?: InputMaybe<Scalars['String']['input']>;
  phone?: InputMaybe<Scalars['String']['input']>;
  review?: InputMaybe<HotelReviewUpdateManyInlineInput>;
};
...
export type ReviewManyWhereInput = {
  ...
  creationDate?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  creationDate_gt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than or equal the given value. */
  creationDate_gte?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values that are contained in given list. */
  creationDate_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']['input']>>>;
  /** All values less than the given value. */
  creationDate_lt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values less than or equal the given value. */
  creationDate_lte?: InputMaybe<Scalars['DateTime']['input']>;
  /** Any other value that exists and is not equal to the given value. */
  creationDate_not?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values that are not contained in given list. */
  creationDate_not_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']['input']>>>;
  ...
  hotel?: InputMaybe<HotelWhereInput>;
  id?: InputMaybe<Scalars['ID']['input']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']['input']>;
  /** All values ending with the given string. */
...
export type ScheduledOperationAffectedDocument = Account | Asset | Hotel | Review;
...
export type CreateHotelReviewMutationVariables = Exact<{
  review: ReviewCreateInput;
}>;


export type CreateHotelReviewMutation = { __typename?: 'Mutation', review?: { __typename?: 'Review', id: string } | null };

export type GetHotelsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetHotelsQuery = { __typename?: 'Query', hotels: Array<{ __typename?: 'Hotel', id: string, name?: string | null, address?: string | null, description?: string | null, image: { __typename?: 'Asset', url: string, id: string } }>, reviews: Array<{ __typename?: 'Review', rating: number }> };
...
export type GetHotelsIdQuery = { __typename?: 'Query', hotels: Array<{ __typename?: 'Hotel', id: string }> };

export type ReviewContentFragment = { __typename?: 'Review', content?: string | null, rating: number, id: string, author?: string | null, createdAt: any } & { ' $fragmentName'?: 'ReviewContentFragment' };

export type GetReviewsForHotelIdQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type GetReviewsForHotelIdQuery = { __typename?: 'Query', hotel?: { __typename?: 'Hotel', id: string, name?: string | null, review: Array<{ __typename?: 'Review', id: string, createdAt: any, content?: string | null, author?: string | null, publishedAt?: any | null, rating: number }> } | null };
...
export const CreateHotelReviewDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateHotelReview"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"review"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ReviewCreateInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"review"},"name":{"kind":"Name","value":"createReview"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"review"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<CreateHotelReviewMutation, CreateHotelReviewMutationVariables>;
...
export const GetReviewsForHotelIdDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetReviewsForHotelID"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hotel"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}},{"kind":"Argument","name":{"kind":"Name","value":"stage"},"value":{"kind":"EnumValue","value":"DRAFT"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"review"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Review"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"author"}},{"kind":"Field","name":{"kind":"Name","value":"publishedAt"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetReviewsForHotelIdQuery, GetReviewsForHotelIdQueryVariables>;